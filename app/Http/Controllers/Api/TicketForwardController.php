...
use App\Services\TicketForwardService;
...
class TicketForwardController extends Controller
{
    ...
    public function __construct(TicketForwardService $service)
    {
    ...
    {
        if (Auth::user()->can('ticketforward-list')) {
    ...
    {
        if (Auth::user()->can('ticket-forward')) {
    ...
    {
        if (Auth::user()->can('ticketforward-edit')) {
    ...
    {
        if (Auth::user()->can('ticketforward-delete')) {
