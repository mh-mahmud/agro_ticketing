...
class Report extends React.Component {
    ...
    async getReportData(pageNumber=1) {
                    ...
                    <div className="col-lg-5">
                        <div className="ts-ticket-buttons-area">
                            ...
                            <path fillRule="evenodd"
                                ...
                                <span className="ts-d-ticket-no">{this.state.reportData.total_ticket ? this.state.reportData.total_ticket : 'N/A'}</span>
                                {this.state.reportData.total_ticket_pct > 0 ? (
                                    <p>
                                        <span className="ts-roi-plus">
                                            <i className="bi bi-forward-fill" /> {this.state.reportData.total_ticket_pct}%
                            ...
                            <path fillRule="evenodd"
                                ...
                                <span className="ts-d-ticket-no">{this.state.reportData.total_create_ticket ? this.state.reportData.total_create_ticket : 'N/A'}</span>
                                {this.state.reportData.create_ticket_pct > 0 ? (
                                    <p>
                                        <span className="ts-roi-plus">
                                            <i className="bi bi-forward-fill" /> {this.state.reportData.create_ticket_pct}%
                                        </span> Since Last Month
                                    </p>
                            ...
                            <path fillRule="evenodd"
                                ...
                                <span className="ts-d-ticket-no">{this.state.reportData.total_open_ticket ? this.state.reportData.total_open_ticket : 'N/A'}</span>
                                {this.state.reportData.open_ticket_pct > 0 ? (
                                    <p>
                                        <span className="ts-roi-plus">
                                            <i className="bi bi-forward-fill" /> {this.state.reportData.open_ticket_pct}%
                                        </span> Since Last Month
                                    </p>
                            ...
                            <path fillRule="evenodd"
                                ...
                                <span className="ts-d-ticket-no">{this.state.reportData.total_close_ticket ? this.state.reportData.total_close_ticket : 'N/A'}</span>
                                {this.state.reportData.closed_ticket_pct > 0 ? (
                                    <p>
                                        <span className="ts-roi-plus">
                                            <i className="bi bi-forward-fill" /> {this.state.reportData.closed_ticket_pct}%
                                        </span> Since Last Month
                                    </p>
