...
class Dashboard extends React.Component {
    ...
    async getDashboardData(pageNumber=1) {
        const response = await (new Api()).call('GET', API_URL + '/dashboard','', (new Token()).get());
        if(response && response.data.status_code === 200) {
            this.setState({dashboardData:response.data.dashboardData});
                    ...
                    <div className="col-lg-12">
                        <div className="ts-ticket-buttons-area">
                            ...
                            <path fillRule="evenodd"
                                ...
                                <span className="ts-d-ticket-no">{this.state.dashboardData.total_ticket ? this.state.dashboardData.total_ticket : 'N/A'}</span>
                                {this.state.dashboardData.total_ticket_pct > 0 ? (
                                    <p>
                                        <span className="ts-roi-plus">
                                            <i className="bi bi-forward-fill" /> {this.state.dashboardData.total_ticket_pct}%
                                        </span> Since Last Month
                                    </p>

                                ) : this.state.dashboardData.total_ticket_pct === '' ? (
                                    <p>-No ticket created in last month</p>
                                  ): (
                                    <p>
                                        <span className="ts-roi-minus">
                                            <i className="bi bi-forward-fill" /> {Math.abs(this.state.dashboardData.total_ticket_pct)}%
                                        </span> Since Last Month
                                    </p>
                                )}
                            ...
                            <div className="ts-d-ticket ts-total-ticket">
                                ...
                                <div className="ts-d-ticket-header">
                                    <span className="ts-d-ticket-title">Pending Ticket</span>
                            ...
                            <path fillRule="evenodd"
                                ...
                                <span className="ts-d-ticket-no">{this.state.dashboardData.total_pending_ticket ? this.state.dashboardData.total_pending_ticket : 'N/A'}</span>
                                {this.state.dashboardData.create_ticket_pct > 0 ? (
                                    <p>
                                        <span className="ts-roi-plus">
                                            <i className="bi bi-forward-fill" /> {this.state.dashboardData.create_ticket_pct}%
                                        </span> Since Last Month
                                    </p>

                                ): this.state.dashboardData.create_ticket_pct === '' ? (
                                    <p>-No ticket created in last month</p>
                                  ) : (
                                    <p>
                                        <span className="ts-roi-minus">
                                            <i className="bi bi-forward-fill" /> {Math.abs(this.state.dashboardData.create_ticket_pct)}%
                                        </span> Since Last Month
                                    </p>
                                )}
                            ...
                            <div className="ts-d-ticket ts-total-ticket">
                                ...
                                <span className="ts-d-ticket-no">{this.state.dashboardData.total_open_ticket ? this.state.dashboardData.total_open_ticket : 'N/A'}</span>
                                {this.state.dashboardData.open_ticket_pct > 0 ? (
                                    <p>
                                        <span className="ts-roi-plus">
                                            <i className="bi bi-forward-fill" /> {this.state.dashboardData.open_ticket_pct}%
                                        </span> Since Last Month
                                    </p>

                                ): this.state.dashboardData.open_ticket_pct === '' ? (
                                    <p>-No ticket created in last month</p>
                                  ) : (
                                    <p>
                                        <span className="ts-roi-minus">
                                            <i className="bi bi-forward-fill" /> {Math.abs(this.state.dashboardData.open_ticket_pct)}%
                                        </span> Since Last Month
                                    </p>
                                )}
                            ...
                            <div className="ts-d-ticket ts-total-ticket">
                                ...
                                <span className="ts-d-ticket-no">{this.state.dashboardData.total_close_ticket ? this.state.dashboardData.total_close_ticket : 'N/A'}</span>
                                {this.state.dashboardData.closed_ticket_pct > 0 ? (
                                    <p>
                                        <span className="ts-roi-plus">
                                            <i className="bi bi-forward-fill" /> {this.state.dashboardData.closed_ticket_pct}%
                                        </span> Since Last Month
                                    </p>

                                ): this.state.dashboardData.closed_ticket_pct === '' ? (
                                    <p>-No ticket created in last month</p>
                                  ) : (
                                    <p>
                                        <span className="ts-roi-minus">
                                            <i className="bi bi-forward-fill" /> {Math.abs(this.state.dashboardData.closed_ticket_pct)}%
                                        </span> Since Last Month
                                    </p>
                                )}
                            </div>
